      ...
      <div className="container">
          ...
          <button
            ...
            onClick={() => {
              ...
              dispatch({
                ...
                payload: {id:transactionId,amount: amount, type: "Debit", date: new Date().toLocaleString()},
              });
              setAmount("");
            }}
          >
          ...
          <button
            ...
            onClick={() => {
              ...
              dispatch({
                type: "ADD_TRANSACTION",
                payload: {id:transactionId,amount: amount, type: "Credit", date: new Date().toLocaleString()},
              });
              setAmount("");
            }}
          >
